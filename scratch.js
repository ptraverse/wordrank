...
// ./node_modules/phantomjs/bin/phantomjs ./scratch.js
// Eventually:
// ./node_modules/phantomjs/bin/phantomjs ./scratch.js --word="ornithology"
// ./node_modules/phantomjs/bin/phantomjs ./scratch.js -w ornithology
...
var steps = [
  ...
  function() {
    ...
    }, testPhrase); //have to bind that variable to make it work in the page.evaluate
  },
